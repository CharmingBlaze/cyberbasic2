...
- **Raylib:** `InitWindow`, `DrawCircle`, etc. or `RL.InitWindow`, … Prefer flat names (InitWindow, DrawCircle) in new code; RL.InitWindow is an alias for porting or clarity.
