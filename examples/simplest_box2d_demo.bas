...
WHILE NOT WindowShouldClose()
  Step2D("world", 1.0 / 60.0, 8, 3)

  ClearBackground(44, 48, 56, 255)
  VAR bx = GetPositionX2D("world", "box")
  VAR by = GetPositionY2D("world", "box")
  VAR sx = ox + bx * scale
  VAR sy = oy - by * scale
